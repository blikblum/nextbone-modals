(function (global, factory) {
  ...
  var ModalView = backbone_marionette.View.extend({
  ...
  var BootstrapModalService = ModalService.extend({
    ...
    setup: function setup() {
      ...
      backbone_marionette.mergeOptions(this, options, viewClassesNames.concat(['el', 'container']));
    ...
    start: function start() {
      ...
      if (!this.container) {
        ...
        this.container = new backbone_marionette.Region({
          el: this.el
        });
      }
      ...
      this.contentRegion = new backbone_marionette.Region({
...
//# sourceMappingURL=marionette.modalservice.js.map
